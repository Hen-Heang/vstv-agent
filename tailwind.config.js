  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // VSTV Brand Colors - Professional Real Estate Palette
        brand: {
          // Primary: VSTV Red (Bold, Trustworthy)
          primary: {
            50: '#fef2f2',
            100: '#fee2e2',
            200: '#fecaca',
          ...
          // Secondary: Professional Navy (Trust, Authority)
          secondary: {
            50: '#f8fafc',
            100: '#f1f5f9',
            200: '#e2e8f0',
          ...
          // Text: Dark Brown/Grey (Professional, Readable)
          text: {
            primary: '#2d3748',
            secondary: '#4a5568',
            muted: '#718096',
