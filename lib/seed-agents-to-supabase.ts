...
export async function seedAgentsToSupabase() {
  console.log('🌱 Seeding agents to Supabase...')
  
  if (!supabase) {
    console.log('❌ Supabase client not configured. Please set up environment variables.')
    return
  }
